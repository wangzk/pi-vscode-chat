...
- **Completion notifications** — a native VS Code notification when the agent finishes, so you can context-switch away while it works. Skipped when you're already watching the chat. Configure via `piChat.notifyOnComplete`.
